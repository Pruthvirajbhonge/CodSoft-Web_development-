...
const portfolioCloseBtns = document.querySelectorAll(".portfolio-colse-btn");
...
const sendEmail = (e) =>
{
    ...
    emailjs.sendForm('service_9barnxf', 'template_ei6hnxc', '#contact_form', '_PfPmd1LU2YNLINpD')
        .then(() =>
        {
...
ScrollReveal().reveal('.home .info h3, .home .info p, .about-info, .profile-container, .btn', { delay: 600, origin: 'right' });
